from mission_control.models import ActionItem, Decision, MeetingAnalysis
from mission_control.orchestrator import MissionControlOrchestrator


def fake_analyzer(transcript: str) -> MeetingAnalysis:
...
def test_orchestrator() -> None:
    orchestrator = MissionControlOrchestrator(analyzer=fake_analyzer)
